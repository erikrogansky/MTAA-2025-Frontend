...
@Composable
fun RegistrationScreen(navController: NavController = rememberNavController(), viewModel: MainViewModel = hiltViewModel(), callbackManager: CallbackManager) {
    ...
    Box(
        ...
        Column(
            ...
            GoogleRegistrationButton(navController.context, viewModel, navController)

            Spacer(modifier = Modifier.height(16.dp))

            FacebookRegistrationButton(navController.context, viewModel, navController, callbackManager)
...
@Composable
fun GoogleRegistrationButton(context: Context, viewModel: MainViewModel, navController: NavController) {
    val colors = LocalCooklyColors.current
...
@Composable
fun FacebookRegistrationButton(
    context: Context,
